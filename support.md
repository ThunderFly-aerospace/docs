...
If you are evaluating ThunderFly products or have a pre-sales question, please use the [contact methods](https://www.thunderfly.cz/contact-us.html) on the ThunderFly website.
...
1. **Collect information** — note the symptoms, firmware or software version, your hardware setup, and any relevant error messages or logs.
2. **Send an email to [support@thunderfly.cz](mailto:support@thunderfly.cz)** including:
...
Some ThunderFly products are based on open-source hardware and software. For community-driven discussions, bug reports, or feature requests outside of commercial support, you are welcome to open an issue in the relevant repository on [GitHub](https://github.com/ThunderFly-aerospace).
